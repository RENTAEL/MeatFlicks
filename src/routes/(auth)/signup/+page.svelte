...
<div class="auth-page">
	<div class="auth-card glass scale-in">
		...
		<p class="auth-subtitle">Start streaming in seconds</p>
		...
		<form method="POST" use:enhance class="auth-form">
			...
			<Button type="submit" class="w-full auth-submit-btn">Sign Up</Button>
		</form>
		...
		<p class="auth-footer">
			...
			<a rel="external" href="/login" class="auth-link">Sign in →</a>
		</p>
	</div>
</div>
